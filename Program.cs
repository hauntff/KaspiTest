...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        context.Persons.Add(new Person { Login = "kaspi", Password = "giveMeOffer", Role = "admin" });
        context.SaveChanges();
        var parsingService = services.GetRequiredService<IParserService>();
        parsingService.ParseNews();
    }
	catch (Exception ex)
    {
